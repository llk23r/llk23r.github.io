...
In November 2025, the JILA group pushed further still; not by building a better clock, but by entangling the atoms inside one. Using spin-squeezed quantum states, they surpassed the standard quantum limit; the fundamental noise floor that limits any measurement of independent particles. Entanglement didn't just improve the clock. It changed what clocks can be.

The clocks have also left the lab. In January 2025, NIST shipped a complete ytterbium optical lattice clock 3,000 kilometers from Boulder to the U.S. Naval Observatory in Washington, DC. It was fully operational within two days. In 2024, a startup called Vector Atomic ran three optical clocks aboard a New Zealand naval vessel for twenty days at sea, maintaining timing errors below 300 picoseconds per day. They now sell the Evergreen-30; the world's first rack-mount commercial optical clock. In June 2025, ten optical clocks across six countries were compared simultaneously, measuring 38 frequency ratios; the most extensive coordinated comparison ever performed.

The definition of the second, unchanged since 1967, is now actively under review. The [28th General Conference on Weights and Measures](https://www.bipm.org/en/cgpm-2026) meets in October 2026 at Versailles to consider the proposal. Ratification is expected by 2030. The 13th General Conference gave us cesium. The 28th may begin to retire it. When it happens, it will be only the second time in human history that we've changed what a second means.

And the chain between the atoms and your devices keeps tightening at the other end too. Precision Time Protocol now synchronizes 5G base stations and data centers to nanoseconds; a thousand times tighter than NTP. In 2024, Meta open-sourced their entire time infrastructure, publishing a simplified PTP variant that any organization can deploy on commodity hardware. CERN's White Rabbit protocol; born to synchronize particle detectors across kilometers of tunnel; was standardized as the High Accuracy profile in IEEE 1588-2019, and by 2025 had been adopted by Deutsche Borse for trading system fairness and by power grids as a GPS-independent timing backup. Network Time Security, the cryptographic layer NTP never had, became the default in Ubuntu 25.10; authenticating the same four-timestamp exchange David Mills designed in 1985.

![A next-generation rubidium vapor cell for a chip-scale atomic clock, shown beside a coffee bean for scale — the cell is smaller than the bean](./images/csac-coffee-bean.jpg "A rubidium vapor cell for NIST's chip-scale atomic clock, next to a coffee bean for scale. Over 100,000 commercial CSACs have been deployed in military radios, 5G base stations, and ocean-floor seismic sensors. Image: Hummon/NIST, public domain.")

Chip-scale atomic clocks; barely larger than a postage stamp; continue to shrink the gap between atomic precision and edge devices. Microchip's newest CSAC, the SA65-LN released in January 2025, achieves ten times better short-term stability than the original 2011 model. Over 100,000 CSACs have been sold; inside military radios navigating without GPS, 5G base stations maintaining synchronization during satellite outages, and seismic sensors on the ocean floor.

Even the quartz crystal; the grain of rice this post began with; is facing a successor. MEMS oscillators, fabricated in silicon rather than cut from mineral, are entering the devices you carry. In 2025, Apple chose SiTime's MEMS oscillators for the iPhone 16e's modem; a 32 kHz resonator for timekeeping and a 76.8 MHz resonator for RF, displacing quartz entirely. Over four billion MEMS oscillators have shipped across the industry. The resonators are a thousand times smaller than quartz crystals, fifty times more reliable, and immune to the helium sensitivity that occasionally bricks quartz-based phones. The tuning fork on your wrist may be among the last of its kind.

The atoms got more precise. The links got shorter. The crystals got smaller. The hierarchy we've traced in this post; from your wrist to the quantum mechanics of electron transitions; is being compressed at every level.
