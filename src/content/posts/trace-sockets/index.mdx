...
<LoadBalancerDiagram client:visible />
...
<JourneyMap steps={journeySteps} current={10} client:visible />
...
<JourneyMap steps={journeySteps} current={13} client:visible />
...
<JourneyMap steps={journeySteps} current={15} client:visible />
...
<JourneyMap steps={journeySteps} current={17} client:visible />
...
<JourneyMap steps={journeySteps} current={19} client:visible />
...
<JourneyMap steps={journeySteps} current={21} client:visible />
...
<JourneyMap steps={journeySteps} current={24} client:visible />
...
<JourneyMap steps={journeySteps} current={26} client:visible />
...
<JourneyMap steps={journeySteps} current={28} client:visible />
...
<KeepAliveComparison client:visible />
...
<PoolArchitecture client:visible />
