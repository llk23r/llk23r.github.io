...
<JourneyMap
  steps={journeySteps}
  current={0}
  client:visible={{ rootMargin: '4000px 0px' }}
/>

<RequestJourney client:visible={{ rootMargin: '4000px 0px' }} />
...
<RequestEnvelopeTrace client:visible={{ rootMargin: '4000px 0px' }} />
...
<AdmissionControlTrace client:visible={{ rootMargin: '4000px 0px' }} />
...
<RequestReservationTrace client:visible={{ rootMargin: '4000px 0px' }} />
...
<ServingStackDiagram client:visible={{ rootMargin: '4000px 0px' }} />
...
<PromptAssemblyPath client:visible={{ rootMargin: '4000px 0px' }} />
...
<PromptEvidenceTrace client:visible={{ rootMargin: '4000px 0px' }} />
...
<GroundedClaimTrace client:visible={{ rootMargin: '4000px 0px' }} />
...
<TokenizationLab client:visible={{ rootMargin: '4000px 0px' }} />
...
<EmbeddingLookupTrace client:visible={{ rootMargin: '4000px 0px' }} />
...
<TokenMergeTrace client:visible={{ rootMargin: '4000px 0px' }} />
...
<TrainingStepTrace client:visible={{ rootMargin: '4000px 0px' }} />
...
<PostTrainingLoop client:visible={{ rootMargin: '4000px 0px' }} />
...
<PostTrainingTrace client:visible={{ rootMargin: '4000px 0px' }} />
...
<ReplicaWarmupTrace client:visible={{ rootMargin: '4000px 0px' }} />
...
<ModelArtifactTrace client:visible={{ rootMargin: '4000px 0px' }} />
...
<GpuMemoryBudget client:visible={{ rootMargin: '4000px 0px' }} />
...
<ReplicaPlacement client:visible={{ rootMargin: '4000px 0px' }} />
...
<TransformerPass client:visible={{ rootMargin: '4000px 0px' }} />
...
<AttentionKvCache client:visible={{ rootMargin: '4000px 0px' }} />
...
<KvCacheTrace client:visible={{ rootMargin: '4000px 0px' }} />
...
<KernelRooflineTrace client:visible={{ rootMargin: '4000px 0px' }} />
...
<DeploymentPlanTrace client:visible={{ rootMargin: '4000px 0px' }} />
...
<TensorParallelTrace client:visible={{ rootMargin: '4000px 0px' }} />
...
<DistributedSync client:visible={{ rootMargin: '4000px 0px' }} />
...
<SamplingTrace client:visible={{ rootMargin: '4000px 0px' }} />
...
<SingleTokenTrace client:visible={{ rootMargin: '4000px 0px' }} />
...
<TestTimeCompute client:visible={{ rootMargin: '4000px 0px' }} />
...
<StreamLifecycle client:visible={{ rootMargin: '4000px 0px' }} />

<StreamTokenReleaseTrace client:visible={{ rootMargin: '4000px 0px' }} />
...
<BatchingSimulator client:visible={{ rootMargin: '4000px 0px' }} />
...
<SchedulerState client:visible={{ rootMargin: '4000px 0px' }} />
...
<SchedulerTickTrace client:visible={{ rootMargin: '4000px 0px' }} />
...
<FleetRolloutTrace client:visible={{ rootMargin: '4000px 0px' }} />
...
<FleetControlLoop client:visible={{ rootMargin: '4000px 0px' }} />
...
<FleetIncidentTrace client:visible={{ rootMargin: '4000px 0px' }} />
...
<IncidentTimelineTrace client:visible={{ rootMargin: '4000px 0px' }} />

<StabilityControlTrace client:visible={{ rootMargin: '4000px 0px' }} />
...
<CompleteLoopTrace client:visible={{ rootMargin: '4000px 0px' }} />
